                                    ...
                                    <div class="masonry-item">
                                        <span class="thumb-info<?php echo $porto_settings['portfolio-zoom'] ? '' : ' thumb-info-lighten' ?> thumb-info-centered-icons thumb-info-no-borders">
                                            <span class="thumb-info-wrapper">
                                                <img width="<?php echo $attachment['width'] ?>" height="<?php echo $attachment['height'] ?>" src="<?php echo $attachment['src'] ?>" class="img-responsive" title="<?php echo $attachment['alt'] ?>" alt="<?php echo $attachment['alt'] ?>">
                                                <?php if ($porto_settings['portfolio-zoom']) : ?>
                                                    <span class="thumb-info-action">
                                                    <a href="<?php echo $attachment['src'] ?>" class="lightbox-portfolio" title="<?php echo ( isset( $attachment['caption'] ) ? $attachment['caption'] : '' ); ?>">
